...
{
	if (sht->height >= 0) { /* ‚à‚µ‚à•\Ž¦’†‚È‚çAV‚µ‚¢‰º‚¶‚«‚Ìî•ñ‚É‰ˆ‚Á‚Ä‰æ–Ê‚ð•`‚«’¼‚· */
...
{
	if (sht->height >= 0) {
		sheet_updown(sht, -1); /* •\Ž¦’†‚È‚ç‚Ü‚¸”ñ•\Ž¦‚É‚·‚é */
	}
